async function analyzeImage() {
    ...
    if (fileInput.files.length > 0) {
      ...
      if (hasWater) {
        resultDiv.innerHTML = '<strong style="color: red;">Área Propensa a Desarrollar o Alojar Mosquitos.</strong>';
    } else {
        resultDiv.innerHTML = '<strong style="color: red;">No se Detectó un Área Propensa a Desarrollar o Alojar Mosquitos.</strong>';
    }
